...
import custombanner from "../../../public/assets/images/categories/software-development/banners/custombanner.png";
...
import sideImage from "../../../public/assets/images/categories/software-development/customSoft.png";
...
import {
  ...
  MainHeading,
  MainDesc
} from "@/data/software-development/custom-software";
    ...
    <>
      <div  className="bg-cover bg-center bg-customWhite h-[600px] rounded-b-3xl">
        ...
        data-aos="fade-down"
          ...
          style={{ backgroundImage: `url(${custombanner.src})`, height: "550px" }}
        >
      ...
      />
     <InquiryForm  parentCategory= {'Software Development'} childcategory ={'Custom'} disableCatgory ={true} /> 
