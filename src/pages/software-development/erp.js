...
import ergBg from "../../../public/assets/images/categories/software-development/banners/erp-banner.jpg";
...
import buildbanner from "../../../public/assets/images/categories/software-development/erpbuildbanner.png";
import {
  working,
  heading,
  description,
  ...
  MainHeading,
  MainDesc
} from "@/data/software-development/erp";
    ...
    <>
      <div  className="bg-cover bg-center bg-customWhite h-[600px] rounded-b-3xl">
        ...
        data-aos="fade-down"
          ...
          style={{ backgroundImage: `url(${ergBg.src})`, height: "550px" }}
        >
      ...
      />
     <InquiryForm  parentCategory= {'Software Development'} childcategory ={'ERP'} disableCatgory ={true} /> 
