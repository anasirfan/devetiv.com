...
import supportbanner from "../../../public/assets/images/categories/software-development/banners/supportbanner.png";
...
import {
  ...
  MainHeading,
  MainDesc
} from "@/data/software-development/support-and-management";
    ...
    <>
      <div className="bg-cover bg-center bg-customWhite h-[600px] rounded-b-3xl">
        ...
        data-aos="fade-down" 
          ...
          style={{ backgroundImage: `url(${supportbanner.src})`, height: "550px" }}
        >
      ...
      />
     <InquiryForm  parentCategory= {'Software Development'} childcategory ={'Support & Management'} disableCatgory ={true} /> 
