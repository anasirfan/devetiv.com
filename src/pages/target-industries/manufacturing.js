...
import educationBg from "../../../public/assets/images/categories/target-industries/manufacturing-banner.png";

import { MainHeading, MainDesc, EducationSectorHeading, EducationSectorParagraph, portfolio } from "@/data/target-industries/manufacturing";
...
const manufacturing = () => {
  return (
    <>
      ...
      <CustomerFocus />
      <InquiryForm industry = {'Manufacturing'} disableIndustry ={true} />
