...
import educationBg from "../../../public/assets/images/categories/target-industries/saas-banner.png";

import { MainHeading, MainDesc, EducationSectorHeading, EducationSectorParagraph, portfolio } from "@/data/target-industries/saas";
...
const retail = () => {
  return (
    <>
      ...
      <CustomerFocus />
      <InquiryForm industry = {'SaaS'} disableIndustry ={true} />
