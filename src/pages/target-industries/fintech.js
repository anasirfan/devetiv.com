...
import educationBg from "../../../public/assets/images/categories/target-industries/fintech-banner.png";

import { MainHeading, MainDesc, EducationSectorHeading, EducationSectorParagraph, portfolio } from "@/data/target-industries/fintech";
...
const fintech = () => {
  return (
    <>
      ...
      <CustomerFocus />
      <InquiryForm industry = {'Fintech'} disableIndustry ={true} />
