...
import educationBg from "../../../public/assets/images/categories/target-industries/education-banner.png";

import { MainHeading, MainDesc, EducationSectorHeading, EducationSectorParagraph, portfolio } from "@/data/target-industries/education";
...
const education = () => {
  return (
    <>
      ...
      <InquiryForm industry = {'Education'} disableIndustry ={true} />
