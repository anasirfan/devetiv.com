...
import educationBg from "../../../public/assets/images/categories/target-industries/hospitality-banner.png";

import { MainHeading, MainDesc, EducationSectorHeading, EducationSectorParagraph, portfolio } from "@/data/target-industries/hospitality";
...
const hospitality = () => {
  return (
    <>
      ...
      <CustomerFocus />
      <InquiryForm industry = {'Hospitality'} disableIndustry ={true} />
