...
import { MainHeading, MainDesc, EducationSectorHeading, EducationSectorParagraph, portfolio } from "@/data/target-industries/retail";
...
const retail = () => {
  return (
    <>
      ...
      <CustomerFocus />
      <InquiryForm industry = {'Retail'} disableIndustry ={true} />
