...
import webBanner from "../../../public/assets/images/categories/app-development/mobile.png";
...
import {
  ...
  MainHeading,
  MainDesc
} from "@/data/app-development/mobile-app";
...
const MobileApp = () => {
  return (
    <>
      ...
      />
     <InquiryForm  parentCategory= {'App Development'} childcategory ={'Mobile App'} disableCatgory ={true} /> 
